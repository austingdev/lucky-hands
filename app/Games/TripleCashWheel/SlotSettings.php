...
namespace VanguardLTE\Games\TripleCashWheel
{
    ...
    class SlotSettings extends BasicSlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->Paytable['0'] = [0, 0, 0, 200, 1000, 2500];
            $this->Paytable['1'] = [0, 0, 0, 100, 500, 1000];
            $this->Paytable['2'] = [0, 0, 0, 50, 200, 500];
            $this->Paytable['3'] = [0, 0, 0, 25, 100, 200];
            $this->Paytable['4'] = [0, 0, 0, 10, 50, 100];
            $this->Paytable['5'] = [0, 0, 0, 5, 25, 50];
            $this->Paytable['6'] = [0, 0, 0, 5, 10, 25];
            $this->Paytable['7'] = [0, 0, 0, 5, 10, 25];
            $this->Paytable['8'] = [0, 0, 0, 1, 3, 6, 30, 400, 1500];            
            $this->Paytable['9'] = [0, 0, 0, 2, 5, 25]; //mixed bar
            $this->Paytable['10'] = [0, 0, 0, 10, 50, 100]; //mixed sevens
            ...
            $this->awardIndices = [
                ...
                '6' => ['3' => 2,'4' => 6,'5' => 11],
                '7' => ['3' => 3,'4' => 7,'5' => 12],
                '8' => ['3' => 32,'4' => 33,'5' => 34, '6' => 35, '7' => 36, '8' => 37, '9' => 38],                
                '9' => ['3' => 8,'4' => 17,'5' => 21],
                '10' => ['3' => 0,'4' => 4,'5' => 13],                
            ];
            ...
            $this->wheelFeature = [300, 2500, 400, 1500, 'FreeSpin', 900, 2000, 300, 1000, 40000, 700, 5000, 900, 1200, 500, 150000, 1000, 400, 1700, 600, 10000, 1500];
            
            $this->reelStrips['Reels01']=[5,5,5,5,5,5,5,3,2,3,3,4,6,8,6,4,6,0,3,1,3,5,4,5,4,3,3,3,6,7,6,6,6,7,6,6];
            $this->reelStrips['Reels02']=[7,3,5,7,3,8,8,6,4,5,1,3,3,1,3,3,1,3,3,1,2,3,0,2,3,7,7,7,7,7,7,5,4,5,5,4];
            $this->reelStrips['Reels03']=[2,6,5,6,7,6,8,8,8,6,7,6,4,4,6,4,4,7,6,6,7,6,2,2,0,2,2,2,2,3,2,2,1,2,2];
            $this->reelStrips['Reels04']=[1,3,2,5,6,7,6,7,0,6,7,3,2,6,7,6,7,6,5,4,5,4,5,4,5,6,8,8,7,6,5,3,2,1,3,2];
            $this->reelStrips['Reels05']=[6,4,5,2,3,4,5,4,7,0,6,5,4,5,1,5,4,5,8,4,5,4,5,4,7,4,5,7];

            $this->reelStrips['Reels11']=[5,4,4,4,5,4,4,3,3,0,3,4,7,8,6,3,7,0,3,2,1,3,3,3,3,3,3,3,0,7,6,7,6,7,6,0];
            $this->reelStrips['Reels12']=[4,2,5,4,2,8,8,2,2,2,5,2,2,2,2,2,0,2,2,2,3,1,0,5,5,7,6,4,7,6,0,5,4,6,5,4];
            $this->reelStrips['Reels13']=[7,6,5,7,6,5,2,0,3,3,3,3,3,3,1,3,3,0,1,3,3,3,3,8,8,8,5,5,5,4,5,5,7,5,5];
            $this->reelStrips['Reels14']=[1,3,2,3,7,6,7,6,0,7,6,5,7,6,7,4,6,7,5,4,5,4,5,4,7,6,7,8,8,6,7,3,2,1,3,2];
            $this->reelStrips['Reels15']=[6,4,5,2,3,4,5,6,7,0,6,7,6,7,5,8,1,7,5,7,7,6,4,5,7,6,4,7];
