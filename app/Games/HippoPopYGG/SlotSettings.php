...
namespace VanguardLTE\Games\HippoPopYGG
{
    ...
    class SlotSettings extends BasicSlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->Paytable['SuperHigh'] = [0, 0, 0, 10, 20, 40];
            $this->Paytable['High1'] = [0, 0, 0, 4, 10, 20];
            $this->Paytable['High2'] = [0, 0, 0, 4, 10, 20];
            $this->Paytable['High3'] = [0, 0, 0, 4, 10, 20];
            $this->Paytable['Mid1'] = [0, 0, 0, 3, 8, 15];
            $this->Paytable['Mid2'] = [0, 0, 0, 3, 8, 15];
            $this->Paytable['Mid3'] = [0, 0, 0, 3, 8, 15];
            $this->Paytable['Low1'] = [0, 0, 0, 2, 5, 10];
            $this->Paytable['Low2'] = [0, 0, 0, 2, 5, 10];
            $this->Paytable['Low3'] = [0, 0, 0, 2, 5, 10];
            $this->Paytable['Low4'] = [0, 0, 0, 2, 5, 10];
