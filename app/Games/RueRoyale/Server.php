<?php 
namespace VanguardLTE\Games\RueRoyale
{
    set_time_limit(5);
                    ...
                    case "spin":
                        ...
                        for($i = 0; $i <= 500 ; $i++)
                        {
                                ...
                                for($m = 1; $m < 6; $m++)
                                {
                                    for($n = 0; $n < 4; $n++)
                                    {
                                        if (\intval($reels['reel'.$m][$n])  >= 18)
                                        {
                                            ...
                                            {
                                                $reels['reel'.$m][$n] = strval(\rand(23,50));
                                            }else if ($fireBallPercent >= 95 && $fireBallPercent < 99)
                                            {
                                                $reels['reel'.$m][$n] = strval(\rand(50,116));
                                            }else if ($fireBallPercent >= 99 && $fireBallPercent <= 100)
                                            {
                                                $reels['reel'.$m][$n] = 117;
                                            }
                                        }
                                            ...
                                            }else 
                                            {
                                                for($a = 0; $a < 5;$a++)
                                                {
                                                    for($b = 7; $b >= $topLimit; $b--)
                                                    {
                                                        ...
                                                        {
                                                            if (\intval($fireLinkTable[$a][$b]) <= 116)
                                                            {
                                                                $currentTotalWin += \intval($totalBet/50) * (50 +  (\intval($fireLinkTable[$a][$b])-18)*25);
                                                            }else 
                                                            {
                                                                $currentTotalWin += \intval($totalBet/50) * 5000;
                                                            }
                            ...
                            if ($gameType == "normal" || $gameType == "freespin")   
                            {
                                ...
                                //         for($b = 0; $b < 4; $b++)
                                //         {
                                //             if (intval($reels['reel'.$a][$b]) >= 18 )
                                //             {
                                //                 $fireBallValue = 0;
                                //                 if (intval($reels['reel'.$a][$b]) <= 116)
                                //                 {
                                //                     $currentTotalWin += \intval($totalBet/50) * (50 +  (\intval($reels['reel'.$a][$b])-18)*25);
                                //                 }else 
                                //                 {
                                //                     $currentTotalWin += \intval($totalBet/50) * 5000;
                                //                 }
                                //                 $fireBallSum += $fireBallValue;
                                //             }
                                //         }
                                //     }
                                //     $totalWin += $fireBallSum;
                                // }
                                if ($gameType == "freespin" || $i > 475 || ($i >= 450 && $totalWin == 0) || ($totalWin <=  $winTypeTmp[1] && $totalWin > 0.7 * $winTypeTmp[1]) || ( $winTypeTmp[1] == 0 && $totalWin == 0))
                                {                                    
                                ...
                                for($a = 0; $a < 5;$a++)
                                {
                                    for($b = 7; $b >= $topLimit; $b--)
                                    {
                                        if(\intval($fireLinkTable[$a][$b]) >= 18)
                                        {
                                            ...
                                            if (\intval($fireLinkTable[$a][$b]) <= 116)
                                            {
                                                $freeSpinTotalWinScore += \intval($totalBet/50) * (50 +  (\intval($fireLinkTable[$a][$b])-18)*25);
                                            }else 
                                            {
                                                $freeSpinTotalWinScore += \intval($totalBet/50) * 5000;
                                            }
                                        }
                                        else if (\intval($fireLinkTable[$a][$b]) == 6)
                                        {
