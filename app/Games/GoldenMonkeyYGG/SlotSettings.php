...
namespace VanguardLTE\Games\GoldenMonkeyYGG
{
    ...
    class SlotSettings extends BasicSlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->Paytable['SYM3'] = [0, 0, 0, 12, 75, 250];
            $this->Paytable['SYM4'] = [0, 0, 0, 10, 60, 200];
            $this->Paytable['SYM5'] = [0, 0, 0, 8, 50, 100];
            $this->Paytable['SYM6'] = [0, 0, 0, 7, 40, 125];
            $this->Paytable['SYM7'] = [0, 0, 0, 6, 30, 100];
            $this->Paytable['SYM8'] = [0, 0, 0, 5, 30, 80];
            $this->Paytable['SYM9'] = [0, 0, 0, 3, 16, 50];
            $this->Paytable['SYM10'] = [0, 0, 0, 3, 14, 50];
            $this->Paytable['SYM11'] = [0, 0, 0, 3, 12, 40];
            $this->Paytable['SYM12'] = [0, 0, 0, 3, 10, 40];            
        ...
        {
            $filename = base_path() . '/app/Games/GoldenMonkeyYGG/'.$reelName.'.txt';
            ...
            if($winType != 'bonus')
            {
                if($winType == 'win')
                {
                    $symbols = ["SYM3","SYM4","SYM5","SYM6","SYM7","SYM8","SYM9","SYM10","SYM11","SYM12"];
                    $sym = $symbols[rand(0, 9)];
                    $cnt = rand(3, 5);
                    for($i = 0; $i < 5; $i++) 
                    {
                        if($i < $cnt)
