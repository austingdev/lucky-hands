            ...
            try
            {
                ...
                switch( $reqId ) 
                {
                    case 'translations':                                
                        ...
                        $response = file(base_path() . '/app/Games/CherryPopYgg/translation.txt')[0];                                                                          
                        break;
                    case 'authenticate':                                
                        ...
                        break;                                
                    case 'clientinfo':
                        $response = '{"code":0,"data":{"id":"2203301519500100062","org":null,"gameid":0,"data":{"appsrv":"","file":"/init/","gameid":"1016","height":"600","license":"","org":"Demo","root":"","type":"Html","width":"800"}},"fn":"clientinfo","utcts":1648653590613}';
                        break;
                    case 'game':
                        $filename = base_path() . '/app/Games/CherryPopYgg/game.txt';
        ...
        function doSpin($slotSettings, &$postData, &$bets, $cmd, &$lastReels, &$spinMultiplier, &$winTypeTmp)
        {
            ...
            if($postData['slotEvent'] != 'freespin')
            {
                ...
                if($allReachedFullHeight)
                {
                    ...
                    $winTypeTmp[0] = 'win';
                    if(rand(0, 100) < 50 || $slotSettings->GetGameData($slotSettings->slotId . 'CoinWin') * $betLine > 10 * $allbet)
                        $winTypeTmp[0] = 'none';
                }
