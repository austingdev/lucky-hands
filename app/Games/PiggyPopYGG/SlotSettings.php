...
namespace VanguardLTE\Games\PiggyPopYGG
{
    ...
    class SlotSettings extends BasicSlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->Paytable['SuperHigh'] = [0, 0, 0, 6, 10, 20, 30];
            $this->Paytable['High1'] = [0, 0, 0, 3, 5, 10, 15];
            $this->Paytable['High2'] = [0, 0, 0, 3, 5, 10, 15];
            $this->Paytable['High3'] = [0, 0, 0, 3, 5, 10, 15];
            $this->Paytable['Mid1'] = [0, 0, 0, 2, 3, 5, 10];
            $this->Paytable['Mid2'] = [0, 0, 0, 2, 3, 5, 10];
            $this->Paytable['Mid3'] = [0, 0, 0, 2, 3, 5, 10];
            $this->Paytable['Low1'] = [0, 0, 0, 1, 2, 3, 6];
            $this->Paytable['Low2'] = [0, 0, 0, 1, 2, 3, 6];
            $this->Paytable['Low3'] = [0, 0, 0, 1, 2, 3, 6];
        ...
        public function GetReelStrips($winType, $lastReels, $boardHeight, $slotEvent)
        {
            $reels = [ //0 is for one symbol, -1 is for replacing 2 popup symbols after winning
                ...
                'reel6' => array_fill(0, $boardHeight, 0)
            ];
            ...
            if($winType == 'bonus')   
            {
                if(count($reels['reel6']) < count($reels['reel1']))
                    $direction = "right";
                else
                    $direction = "left";
            }
            ...
            if($winType == 'win' || $winType == 'bonus')
            {
                ...
                if($direction == 'left') 
                {
                    ...
                    {
                        foreach($reels['reel1'] as $sym)
                        {
                            if(in_array($sym, $reels['reel2'], true))
                            {
                                $winningSym = $sym;
                                break;
                            }
                ...
                {   
                    if(!in_array(0, $reels['reel6'], true) && !in_array(-1, $reels['reel6'], true))
                    {
                        foreach($reels['reel6'] as $sym)
                        {
                            if(in_array($sym, $reels['reel5'], true))
                            {
                                $winningSym = $sym;
                                break;
                            }
