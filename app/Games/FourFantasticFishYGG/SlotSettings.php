...
namespace VanguardLTE\Games\FourFantasticFishYGG
{
    ...
    class SlotSettings extends BasicSlotSettings
    {
        ...
        public function __construct($sid, $playerId)
        {
            ...
            $this->Paytable[0] = [0,0,0,0,0,0,0];    //scatter
            $this->Paytable[1] = [0,0,0,0,0,0,0];    //wild
            $this->Paytable[2] = [0,0,4,10,30,50,100];
            $this->Paytable[3] = [0,0,2,5,15,30,40];
            $this->Paytable[4] = [0,0,2,5,15,30,40];
            $this->Paytable[5] = [0,0,0,4,10,20,30];
            $this->Paytable[6] = [0,0,0,4,10,20,30];
            $this->Paytable[7] = [0,0,0,3,7,15,25];
            $this->Paytable[8] = [0,0,0,3,7,15,25];
            $this->Paytable[9] = [0,0,0,2,5,12,20];
            $this->Paytable[10] = [0,0,0,2,5,12,20];
            $this->Paytable[11] = [0,0,0,2,5,10,15];
            $this->Paytable[12] = [0,0,0,2,5,10,15];
        ...
        {
            $filename = base_path() . '/app/Games/FourFantasticFishYGG/'.$reelName.'.txt';
            ...
            $choice = rand(0, count($reelStrips->reels) - 1);
            $reelStrips = $reelStrips->reels[$choice];
            if($winType != 'bonus')
            {
                if($winType == 'win')
                {
                    ...
                    for($i = 0; $i < 6; $i++) 
                    {
                        $prs[$i + 1] = $this->GetSymbolPos($reelStrips[$i], $sym, $endLen);
                    }                                        
                }
                else
                {
                    for($i = 0; $i < 6; $i++) 
                    {
                        $prs[$i + 1] = mt_rand(1, count($reelStrips[$i]) - $endLen);
                    }
                }
            ...
            else
            {
                ...
                for( $i = 0; $i < count($reelsId); $i++ ) 
                {
                    if( $i < $scattersCnt ) 
                    {
                        $prs[$reelsId[$i]] = $this->GetRandomScatterPos($reelStrips[$reelsId[$i] - 1], $endLen, $symb);
                    }
                    else
                    {
                        $prs[$reelsId[$i]] = rand(1, count($reelStrips[$reelsId[$i] - 1]) - $endLen);
                    }
                }
            }
