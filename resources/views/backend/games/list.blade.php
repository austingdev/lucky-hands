			...
			<div class="box box-primary">
				<div class="box-header with-border">
					...
					<div class="pull-right box-tools">
						...
						@endif
						<button class="btn btn-success btn-sm" type="submit">@lang('app.change')</button>
					</div>
					@else
						<div class="pull-right box-tools">
							<input type="hidden" name="action" id="action">
							@permission('games.enable')
							<button class="btn btn-success btn-sm" type="button" id="enableGames">@lang('app.enable')</button>
							@endpermission
							@permission('games.disable')
							<button class="btn btn-success btn-sm" type="button" id="disableGames">@lang('app.disable')</button>
							@endpermission
						</div>
					@endif
				</div>
