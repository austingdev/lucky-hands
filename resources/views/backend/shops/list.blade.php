		...
		<div class="box box-primary">
			<div class="box-header with-border">
                ...
                <div class="pull-right box-tools">
                    ...
                    @if(auth()->user()->hasRole('admin'))
                        <a href="{{ route('backend.shop.admin_create') }}" class="btn btn-success hidden btn-sm">@lang('app.add')</a>
					@elseif(auth()->user()->hasRole('distributor'))
                        <a href="{{ route('backend.shop.admin_create') }}" class="btn btn-success hidden btn-sm">@lang('app.add')</a>
                    @else
						
                        <a href="{{ route('backend.shop.create') }}" class="btn btn-success btn-sm">@lang('app.add')</a>
                    @endif
                    @endpermission
                    @permission('shops.free_demo')
                        @if(!auth()->user()->free_demo)
                            <a href="{{ route('backend.shop.get_demo') }}" class="btn btn-success btn-sm">@lang('app.free_demo')</a>
                        @endif
                    @endpermission
                    @if(auth()->user()->hasRole('admin'))
                        <a href="{{ route('backend.shop.fast_shop') }}" class="btn btn-success btn-sm">@lang('app.fast_shop')</a>
                    @endif
                </div>
			...
			<div class="modal-content">
				<form action="{{ route('backend.shop.balance') }}" method="POST" id="outForm">
					...
					<div class="modal-footer">
						...
						<button type="submit" class="btn btn-success">@lang('app.pay_out')</button>
					</div>
				</form>
			</div>
		</div>
