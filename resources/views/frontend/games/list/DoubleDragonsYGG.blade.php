...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('.home-btn').css("left", "5px");
            $('.home-btn').css("right", "auto");
            var isMobile;
            ...
            var url;
            if(isMobile)
                url = '/games/DoubleDragonsYGG/mobile/init/launchClient.html';
            else
                url = '/games/DoubleDragonsYGG/desktop/init/launchClient.html';
