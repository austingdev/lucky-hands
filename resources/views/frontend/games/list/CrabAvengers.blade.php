...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var url;            
            url = '/games/{{ $game->name }}/www.goldentreasure.mobi/game/index.html?gameId=1004&uid=712&token=O4cEwky45sXlfoZkJUnjQaais236&cdn=games/CrabAvengers/cdn.goldentreasure.mobi&musicSwitch=true&lang=en&domainName=www.goldenfortune.game&type=1&gl=1004,1104,1204';
