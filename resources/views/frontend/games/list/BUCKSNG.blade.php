...
@section('scripts')
    <script type="text/javascript">        
        ...
        var qstr = '?launcher=true&sfx_289112219=1613355678748&commonVersion=(build%2085)&game=327&userId=0&wshost=&quality=hd&lang=en&noframe=yes';
        $(document).ready(function() {            
            var isMobile;
            var url = '/games/BUCKSNG/app/bucksHoldNLink.12/index.html';
