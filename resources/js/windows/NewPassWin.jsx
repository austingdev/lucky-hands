...
import { newPassword } from '../server/server';
			...
			<div className="modal-window-npass">
				<div className="modal-window-npass__scale-cont">
					...
					<div className="modal-window-npass__error">
						...
						<img  src="/images/fish/popup/pass_err.png" alt=""/>
					</div>
					<img className="modal-window-npass__close game-button" onClick={this.onClose} src="/images/fish/popup/close_btn.png" alt=""/>
					<img className="modal-window-npass__ok game-button" onClick={this.onChange} src="/images/fish/popup/change_p_btn.png" alt=""/>
					<img className="modal-window-npass__back" src="/images/fish/popup/pass_back.png" alt=""/>
				</div>
			</div>
		)
	}
