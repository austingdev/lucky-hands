        ...
        (function(t) {
            var e = function(t) {
                ...
                return i(e, t), e.prototype.onLoad = function() {
                    ...
                    this.node.active ? (this.node.active = !1, v.AudioMgr.Instance.Play("Btn_Select_n_v01", !1, 1)) : console.warn("[BulletinBoard]some one call close again!")
                }, e.prototype.OnCategoryTabClicked = function(t) {
                    this.m_needPlayClickAudio && v.AudioMgr.Instance.Play("Btn_Sort", !1, 1), this.m_curTabIndex = 0;
                    var e = this.ShowCategoryContent(t);
                    if (this.m_isWaitForPage && this.OnMultiplePageEnd(), e) {
                        var o = this.m_aryCategoryData[this.m_curCategoryIndex].haveRedPoint ? 1 : 0;
                        C.LobbyClient.Instance.GetUserClient.recordClickLog("NewsClickTab", o)
                    }
                }, e.prototype.OnMenuTabClicked = function(t, e) {
                    this.m_needPlayClickAudio && v.AudioMgr.Instance.Play("Btn_LeftTabClick", !1, 1), this.m_curTabIndex = e, console.log("[BulletinBaord]OnMenuTabClicked > ", this.m_curTabIndex), this.ShowPageByID(t);
                    var o = this.CheckCookieForRedPoint(t) ? 2 : 3;
                    C.LobbyClient.Instance.GetUserClient.recordClickLog("NewsClickTab", o), this.CheckCategoryRedPointStatus(t)
                    ...
                    switch (t.buttonType) {
                        case B.CUSTOM:
                            ...
                            break;
                        case B.SWITCH_GAME:
                            e = "call_switch_game", o = this.GetThemeIdByGameName(o);
                            break;
                        case B.URL:
                            e = "call_webview";
                            break;
                        case B.NEW_TAB:
                            e = "";
                            var n = window.open("about:blank", "redirect");
                            n.opener = null, n.location.href = o;
                            break;
                        case B.REFRESH_URL:
                            e = "", window.location.href = o
                    }
                    if (e.length > 0) {
                        var i = new cc.Event.EventCustom(e, !0);
                        i.setUserData(o), this.node.dispatchEvent(i);
                        var r = {
                            popup: o
                        };
                        C.LobbyClient.Instance.GetUserClient.recordClickLog("NewsClickPopup", 0, r)
                    }
                ...
                }, r([I(cc.Node)], e.prototype, "m_root", void 0), r([I(d)], e.prototype, "m_category", void 0), r([I(m)], e.prototype, "m_menu", void 0), r([I(cc.Node)], e.prototype, "m_PageRoot", void 0), r([I(cc.Node)], e.prototype, "m_Loading", void 0), r([I({
                    displayName: "\u6e2c\u8a66\u8cc7\u6599\u55ce"
                })], e.prototype, "m_isTestMode", void 0), r([D], e)
            }(cc.Component);
                                            ...
                                            switch (s.label) {
                                                ...
                                                case 1:
                                                    return s.sent(), u != l.cid ? [2, {
                                                        value: void 0
                                                    }] : null == c ? (n++, [2, "continue"]) : (e.m_arySprites.push(new cc.SpriteFrame(c)), l.m_aryButtnData.push(new _(a)), [2])
                                            }
                                        })
