(function() {
    ...
    function G(a,
        ...
        function r(f, c) {
            var l = window.screen,
                ...
                d = e(l.availHeight, l.availWidth,
                    "landscape", f);
        ...
        if (A) {
            var y = a.background_color || "#f8f9fa",
                P = K(y);
            (B = U(a.related_applications)) &&
            k("apple-itunes-app", "app-id=" + B);
            ...
            por: "portrait",
            lan: "landscape"
        }[String(a.orientation || "").substr(0, 3)] || "", k("x5-orientation", p), k("screen-orientation", p), "fullscreen" === B ? (k("x5-fullscreen", "true"), k("full-screen", "yes")) : q && (k("x5-page-mode",
    ...
    function J(a, b, e) {
        ...
        var g = D(a);
        g.drawImage(a, 0, 0);
        if (e || 255 !== g.getImageData(0, 0, 1, 1).data[3]) return g.globalCompositeOperation = "destination-over", g.fillStyle = b, g.fillRect(0,
