...
(function(e) {
    var b = function() {
        ...
        a.SetFullScreen = function() {
            for (var b = a.m_Document.body, c, e = "requestFullscreen requestFullScreen webkitRequestFullscreen webkitRequestFullScreen msRequestFullscreen msRequestFullScreen mozRequestFullScreen mozRequestFullscreen".split(" "), n, f = "exitFullscreen cancelFullScreen exitFullScreen webkitCancelFullScreen webkitExitFullscreen msCancelFullScreen msExitFullscreen mozCancelFullScreen mozExitFullscreen".split(" "), g = 0; g < e.length; g++)
                if (b[e[g]]) {
                    c =
                        e[g];
                    break
