window.__require = function t(e, o, n) {
    ...
    BulletinBoardCategory: [function(t, e, o) {
        ...
        var l = t("./BulletinBoardMenu"),
            u = t("./BulletinBoardTab"),
            c = l.BulletinBoard.Menu,
            h = u.BulletinBoard.Tab,
            p = cc._decorator,
            d = p.ccclass,
            m = p.property;
        (function(t) {
            var e = function(t) {
                ...
                return i(e, t), e.prototype._onDestroy = function() {
                    SS.Common.ReleaseAsyncSource(), t.prototype._onDestroy.call(this)
    ...
    BulletinBoardManager: [function(t, e, o) {
        ...
        var l, u = t("./BulletinBoardCategory"),
            c = t("./BulletinBoardMenu"),
            h = t("./BulletinBoardPage"),
            p = t("./BulletinBoardData"),
            d = u.BulletinBoard.Category,
            m = c.BulletinBoard.Menu,
            _ = h.BulletinBoard.Page,
            y = p.BulletinBoard.CategoryData,
            g = p.BulletinBoard.TabData,
            f = p.BulletinBoard.PageData,
            T = p.BulletinBoard.PageType,
            S = p.BulletinBoard.ButtonData,
            P = p.BulletinBoard.ButtonType,
            B = t("../../../Component/BundleCtrl"),
            v = t("../../../Component/AudioMgr"),
            C = t("../../../Net/LobbyClient"),
            b = t("../../../PopupMessage/Script/PopupMsgMgr"),
            D = t("../../../Net/ClickLog");
        (function(t) {
            t[t.ClickEvent = 0] = "ClickEvent", t[t.CategoryTabTypeFish = 1] = "CategoryTabTypeFish", t[t.MenuTabTypeFish = 2] = "MenuTabTypeFish", t[t.CategoryTabTypeSlot = 3] = "CategoryTabTypeSlot", t[t.MenuTabTypeSlot = 4] = "MenuTabTypeSlot", t[t.CategoryTabTypeHot = 5] = "CategoryTabTypeHot", t[t.CategoryTabTypeRules = 6] = "CategoryTabTypeRules", t[t.BulletinBoardClose = 7] = "BulletinBoardClose", t[t.CategoryTabTypeOther = 8] = "CategoryTabTypeOther", t[t.MenuTabTypeOther = 9] = "MenuTabTypeOther"
        })(l || (l = {}));
        var w, I = cc._decorator,
            O = I.ccclass,
            E = I.property;
        (function(t) {
            var e = function(t) {
                function e() {
                    var e = null !== t && t.apply(this, arguments) || this;
                    return e.m_root = null, e.m_category = null, e.m_menu = null, e.m_PageRoot = null, e.m_Loading = null, e.m_aryPageData = null, e.m_aryCategoryData = null, e.m_lastCategoryIndex = -1, e.m_curCategoryIndex = -1, e.m_curTabIndex = 0, e.m_curPageID = "", e.m_autoScrollDelayTime = 5, e.m_isAutoScrollRuning = !1, e.m_isHandHold = !1, e.m_isWaitForPage = !1, e.m_logoMode = -1, e.m_needPlayClickAudio = !1, e.m_strHotID = "hot", e.m_isShow = !1, e.m_isInitFinish = !1, e.m_isTestMode = !1, e
                }
                return i(e, t), e.prototype.onLoad = function() {
                    console.log("[BulletinBoard] _onLoad"), this.Init()
                }, e.prototype.onDestroy = function() {
                    this.node.targetOff(this), SS.Common.ReleaseAsyncSource(), this.StopAutoScrollPage(), this.Reset(), this.m_category._onDestroy(), this.m_menu._onDestroy(), this.m_aryPageData = null, this.m_aryCategoryData = null, this.m_category = null, this.m_menu = null
                    ...
                    if (this.m_root.active = !1, this.StopAutoScrollPage(), this.unscheduleAllCallbacks(), this.m_isShow = !1, this.node.targetOff(this), this.m_category.Exit(), this.m_menu.Exit(), this.m_category.Hide(), this.m_menu.Hide(), this.m_Loading.active = !1, this.m_aryCategoryData = [], this.m_isAutoScrollRuning = !1, this.m_curCategoryIndex = -1, this.m_lastCategoryIndex = -1, this.m_curTabIndex = -1, this.m_curPageID = "", this.m_needPlayClickAudio = !1, this.m_PageRoot && this.m_PageRoot.children && this.m_PageRoot.childrenCount > 0 && this.m_PageRoot.removeAllChildren(), this.m_aryPageData)
                        for (; this.m_aryPageData.length > 0;) {
                            ...
                            t.nodePage && (t.nodePage.Exit(), t.nodePage._onDestroy(), t.nodePage.destroy())
                        }
                    ...
                    null == n && (console.warn("[BulletinBoard]I can't find Page <" + t + "> data!"), (n = new f).id = t, o = this.m_aryCategoryData[this.m_curCategoryIndex].menuAry[this.m_curTabIndex], this.CheckPageTypeIsCustom(o.callType) && (n.type = T.CUSTOM, n.prefabName = "BulletinBoard_" + o.callType), this.m_aryPageData.push(n)), this.ShowPage(n)
                    ...
                    return a(this, void 0, void 0, function() {
                        ...
                        return s(this, function(r) {
                            switch (r.label) {
                                case 0:
                                    switch (e = "", o = !1, t.type) {
                                        case T.SINGLE_TEXTURE:
                                            e = "Prefabs/BulletinBoardSinglePopupPage";
                                            break;
                                        case T.MULTIPLE_TEXTURE:
                                    ...
                                    return [4, B.default.Instance.GetOtherPrefab("BulletinBoard", e)];
                                case 1:
                    ...
                    this.m_Loading.active = !0, this.m_isShow = !0, this.m_isTestMode ? this.OnClickTest() : C.LobbyClient.Instance.GetUserClient.GetPopupBillBoard(this.m_logoMode, this.RecvCategoryJsonData.bind(this))
                    ...
                    } else o == P.CUSTOM && SS.Common.GameEnvironment.GameSetting.hasOwnProperty("active_event") && (e = !SS.Common.GameEnvironment.GameSetting.active_event.hasOwnProperty(n) || !SS.Common.GameEnvironment.GameSetting.active_event[n]);
                    return e
                }, e.prototype.SendPopupJsonData = function(t, e) {
                    this.m_Loading.active = !0, this.m_isTestMode ? this.TestToGetPopupJsonData(e) : C.LobbyClient.Instance.GetUserClient.GetPopupContent(this.m_logoMode, t, e, this.RecvPopupJsonData.bind(this))
                        ...
                        if (null == i) {
                            if ((i = new f).id = o, i.data = n, cc.log("[BulletinBoard]RecvPopupJsonData: " + i.id + "\ndata:", i.data), i.data)
                                if (1 == n.length) {
                                    ...
                                    r.indexOf(".png") > -1 ? i.type = T.SINGLE_TEXTURE : (i.type = T.CUSTOM, i.prefabName = r)
                                } else i.type = T.MULTIPLE_TEXTURE;
                    ...
                    this.node.active ? (this.ClickLog(l.BulletinBoardClose), this.node.active = !1, v.AudioMgr.Instance.Play("Btn_Select_n_v01", !1, 1)) : console.warn("[BulletinBoard]some one call close again!")
                }, e.prototype.OnCategoryTabClicked = function(t, e, o) {
                    void 0 === o && (o = !1);
                    var n = this.m_curTabIndex,
                        i = this.m_curCategoryIndex;
                    this.m_needPlayClickAudio && v.AudioMgr.Instance.Play("Btn_Sort", !1, 1), this.m_curTabIndex = 0;
                    var r = this.ShowCategoryContent(t);
                    if (this.m_isWaitForPage && this.OnMultiplePageEnd(), r && o && this.m_aryCategoryData[e] && this.m_aryCategoryData[e].title) {
                        var a = l.CategoryTabTypeOther;
                        switch (this.m_aryCategoryData[e].title) {
                            case "SLOT":
                                a = l.CategoryTabTypeSlot;
                                break;
                            case "HOT":
                                a = l.CategoryTabTypeHot;
                                break;
                            case "FISH":
                                a = l.CategoryTabTypeFish;
                                break;
                            case "RULES":
                                a = l.CategoryTabTypeRules;
                                break;
                            default:
                                a = l.CategoryTabTypeOther
                        }
                        this.ClickLog(a, i, n, this.m_aryCategoryData[e].title)
                    }
                }, e.prototype.OnMenuTabClicked = function(t, e, o) {
                    void 0 === o && (o = !1);
                    var n = this.m_curTabIndex,
                        i = this.m_curCategoryIndex;
                    if (this.m_needPlayClickAudio && v.AudioMgr.Instance.Play("Btn_LeftTabClick", !1, 1), this.m_curTabIndex = e, console.log("[BulletinBaord]OnMenuTabClicked > ", this.m_curTabIndex), this.ShowPageByID(t), o && this.m_aryCategoryData[i] && this.m_aryCategoryData[i].title) switch (this.m_aryCategoryData[i].title) {
                        case "SLOT":
                            this.ClickLog(l.MenuTabTypeSlot, i, n);
                            break;
                        case "FISH":
                            this.ClickLog(l.MenuTabTypeFish, i, n);
                            break;
                        default:
                            this.ClickLog(l.MenuTabTypeOther, i, n)
                    }
                    ...
                    return a(this, void 0, void 0, function() {
                        ...
                        return s(this, function(r) {
                            switch (r.label) {
                                case 0:
                                    switch (e = "", o = t.action, this.ClickLog(l.ClickEvent), t.buttonType) {
                                        case P.CUSTOM:
                                            return [3, 1];
                                        case P.SWITCH_GAME:
                                            return [3, 2];
                                ...
                                case 5:
                                    return [4, D.ClickLog.SendRecordedList("PopUp")];
                                case 6:
                                    return r.sent(), e = "", window.location.href = o, [3, 8];
                                case 7:
                                    return [3, 8];
                                case 8:
                                    return e.length > 0 && ((i = new cc.Event.EventCustom(e, !0)).setUserData(o), this.node.dispatchEvent(i)), [2]
                            }
                        })
                    })
                ...
                }, e.prototype.ClickLog = function(t, e, o, n) {
                    if (void 0 === e && (e = this.m_curCategoryIndex), void 0 === o && (o = this.m_curTabIndex), void 0 === n && (n = ""), this.m_aryCategoryData && this.m_aryCategoryData[e] && this.m_aryCategoryData[e].menuAry && this.m_aryCategoryData[e].menuAry[o]) {
                        var i = this.m_aryCategoryData[e].menuAry[o].id,
                            r = this.m_aryPageData.find(function(t) {
                                return t.id == i
                            });
                        console.log("[\u5e03\u544a\u6b04 ClickLog] pageData = ", r);
                        var a = JSON.parse("{}");
                        if (r && r.nodePage) {
                            var s = r.nodePage.GetPopupID();
                            if (console.warn("[BulletinBoard] pageData popupID  = " + r.nodePage.GetPopupID()), r.data && "" != s) {
                                for (var l = "", u = 0; u < r.data.length; u++)
                                    if (r.data[u].PopupID == s) {
                                        l = r.data[u].extra_data;
                                        break
                                    }
                                "" != l && (a.TempStr1 = l.Name, a.TempStr2 = l.Type, a.TempStr4 = l.Version)
                            } else a.TempStr1 = r.id;
                            a.TempInt1 = t, n && (a.TempStr3 = n), D.ClickLog.recordClickLogNewVersion("PopUp", a)
                        }
                    }
                ...
                }, r([E(cc.Node)], e.prototype, "m_root", void 0), r([E(d)], e.prototype, "m_category", void 0), r([E(m)], e.prototype, "m_menu", void 0), r([E(cc.Node)], e.prototype, "m_PageRoot", void 0), r([E(cc.Node)], e.prototype, "m_Loading", void 0), r([E({
                    displayName: "\u6e2c\u8a66\u8cc7\u6599\u55ce"
                })], e.prototype, "m_isTestMode", void 0), r([O], e)
            }(cc.Component);
        ...
        (function(t) {
            var e = function(t) {
                ...
                return i(e, t), e.prototype.isShowing = function() {
                    ...
                    var o = this;
                    if (void 0 === e && (e = !1), t.id != this.m_strCurFocusID) {
                        t.SetFocus(this.m_aryTabs.length);
                        var n = this.m_aryTabs.find(function(t) {
                            return t.id == o.m_strCurFocusID
                        });
                        null != n && n.SetNormal(), this.CustomClickEvent(t, n), this.m_strCurFocusID = t.id, null != this.funcClicked && this.funcClicked(t.id, t.index, e)
                    }
                ...
                }, r([u(cc.Node)], e.prototype, "m_nodeRoot", void 0), r([u(cc.ScrollView)], e.prototype, "m_scrollView", void 0), r([u(cc.Node)], e.prototype, "m_nodeBalckShadow", void 0), r([u(cc.Layout)], e.prototype, "m_layout", void 0), r([u(cc.Prefab)], e.prototype, "m_tabPrefab", void 0), r([u(cc.Node)], e.prototype, "m_nodeLastest", void 0), r([u], e.prototype, "m_numScrollEnableCount", void 0), r([l], e)
            }(cc.Component);
            t.Menu = e
        })(o.BulletinBoard || (o.BulletinBoard = {})), cc._RF.pop()
    }, {
    ...
    BulletinBoardMultiplePage: [function(t, e, o) {
        ...
        var l, u = t("./BulletinBoardPage"),
            c = t("./BulletinBoardData"),
            h = t("./BulletinBoardPageViewer"),
            p = t("./BulletinBoardIndicator"),
            d = u.BulletinBoard.Page,
            m = u.BulletinBoard.LoadJob,
            _ = c.BulletinBoard.ButtonData,
            y = c.BulletinBoard.ButtonType,
            g = h.BulletinBoard.PageView,
            f = p.BulletinBoard.Indicator,
            T = t("../../../Component/AudioMgr"),
            S = cc._decorator,
            P = S.ccclass,
            B = S.property;
        (function(t) {
            var e = function(t) {
                function e() {
                    var e = null !== t && t.apply(this, arguments) || this;
                    return e.m_btnAction = null, e.m_lblAction = null, e.m_PageView = null, e.m_Indicator = null, e.m_arySprites = [], e.m_aryButtnData = null, e.m_aryPopupID = [], e.m_lastIndex = 0, e.m_curIndex = 0, e.m_autoScrollDelayTime = 5, e.cid = 0, e
                }
                return i(e, t), e.prototype.GetPopupID = function() {
                    return this.m_aryPopupID.length == this.m_arySprites.length ? this.m_aryPopupID[this.m_lastIndex] : ""
                }, e.prototype._onLoad = function() {
                    t.prototype._onLoad.call(this)
                }, e.prototype._onDestroy = function() {
                    this.m_PageView && this.m_PageView._onDestroy(), t.prototype._onDestroy.call(this)
                    ...
                    this.m_PageView && (this.m_PageView.node.targetOff(this), this.m_PageView.StopAutoScrollPageView()), this.m_arySprites = null, this.m_aryButtnData = null, this.m_aryPopupID = null, t.prototype.Exit.call(this)
                    ...
                    this.m_btnAction.node.active = !1, this.m_aryButtnData = [], this.m_arySprites = [], this.m_aryPopupID = [], this.LoadPopupData(t)
                }, e.prototype.OnClick = function() {
                    T.AudioMgr.Instance.Play("Btn_Select_y_v01", !1, 1), null != this.m_funcClicked && this.m_funcClicked(this.m_aryButtnData[this.m_curIndex])
                }, e.prototype.LoadPopupData = function(t) {
                    return a(this, void 0, void 0, function() {
                        var e, o, n, i, r, a, l, u, c;
                                ...
                                case 0:
                                    this.cid++, console.log("[BulletingBoard][MultiPage]:LoadPopupData()"), e = this, o = t.length, n = 0, i = "", r = "", a = function(o) {
                                        ...
                                        return s(this, function(s) {
                                            switch (s.label) {
                                                case 0:
                                                    return a = t[o], l.CheckKioskGame(a.bind_info) ? (n++, [2, "continue"]) : l.CheckEndTime(a.EndTime) ? (n++, [2, "continue"]) : (i = a.BundleVersion, (r = l.GetDownloadPath(i, "Popup", a.BundleName)) ? (u = 0, c = null, [4, (new m).DownloadTexture(l.cid, r).then(function(t) {
                                                        u = t.cid, c = t.result
                                                    }).catch(function(t) {
                                                        u = t.cid, c = null
                                                    })]) : (n++, console.warn("[BulletinVBoard.MultiplePage]Image Path (Popup/" + i + "/" + a.BundleName + ") is NULL!! "), [2, "continue"]));
                                                case 1:
                                                    return s.sent(), u != l.cid ? [2, {
                                                        value: void 0
                                                    }] : null == c ? (n++, [2, "continue"]) : (l.m_aryPopupID.push(a.PopupID), e.m_arySprites.push(new cc.SpriteFrame(c)), l.m_aryButtnData.push(new _(a)), [2])
                                            }
                                        })
                                    }, l = this, u = 0, h.label = 1;
                                case 1:
                                    return u < o ? [5, a(u)] : [3, 4];
                                case 2:
                                ...
                                case 0:
                                    console.log("[BulletingBoard][MultiPage]:ReloadPopupData()"), e = this, o = t.length, n = 0, i = "", r = "", a = function(o) {
                                        ...
                                        return s(this, function(s) {
                                            switch (s.label) {
                                                case 0:
                                                    return a = t[o], l.CheckKioskGame(a.bind_info) ? (n++, [2, "continue"]) : (console.log("<><>Name:", l.m_arySprites[o].getTexture().name), o < l.m_arySprites.length && l.m_arySprites[o] && a.BundleName == l.m_arySprites[o].getTexture().name ? [2, "continue"] : l.CheckEndTime(a.EndTimeUTC) ? (n++, [2, "continue"]) : (i = a.BundleVersion, (r = l.GetDownloadPath(i, "Popup", a.BundleName)) ? (u = null, [4, l.DownloadTexture(r).then(function(t) {
                                                        u = t
                                                    }).catch(function() {
                                                        u = null
                                                    })]) : (n++, console.warn("[BulletinVBoard.MultiplePage]Image Path (Popup/" + i + "/" + a.BundleName + ") is NULL!! "), [2, "continue"])));
                                                case 1:
                                                    return s.sent(), null == u ? (n++, [2, "continue"]) : (e.m_arySprites.length > o ? (e.m_arySprites[o].setTexture(u), l.m_aryButtnData[o] = new _(a)) : (e.m_arySprites.push(new cc.SpriteFrame(u)), l.m_aryButtnData.push(new _(a))), [2])
                                            }
                                        })
                                    }, l = this, u = 0, c.label = 1;
                                case 1:
                                    return u < o ? [5, a(u)] : [3, 4];
                                case 2:
                                    c.sent(), c.label = 3;
                    ...
                    1 != t ? (0 == t ? this.m_curIndex-- : 2 == t && this.m_curIndex++, this.m_curIndex >= this.m_arySprites.length && (this.m_curIndex = 0), this.m_curIndex < 0 && (this.m_curIndex = this.m_arySprites.length - 1), this.m_curIndex == this.m_arySprites.length - 1 && this.m_funcCallAutoScroll && (this.m_funcCallAutoScroll(), this.m_funcCallAutoScroll = null), this.m_lastIndex = this.m_curIndex, this.ShowNewTexture(), this.m_PageView.PlayAutoScrollPageView(), T.AudioMgr.Instance.Play("Btn_MultiPopupMove", !1, 1)) : this.SetButton()
                ...
                }, r([B(cc.Button)], e.prototype, "m_btnAction", void 0), r([B(cc.Label)], e.prototype, "m_lblAction", void 0), r([B(g)], e.prototype, "m_PageView", void 0), r([B(f)], e.prototype, "m_Indicator", void 0), r([P], e)
            }(d);
            t.MultiplePage = e
        })(l || (l = {})), cc._RF.pop()
    }, {
            ...
            function(t) {
                var e = function(t) {
                    ...
                    return i(e, t), e.prototype.SetTextures = function(t) {
                        this.getPages().forEach(function(e, o) {
        ...
        u.property,
            function(t) {
                var e = function(t) {
                    function e() {
                        var e = null !== t && t.apply(this, arguments) || this;
                        return e.pageID = "", e.m_lastPopupID = "", e.m_funcClicked = null, e.m_funcResetComplete = null, e.m_funcCallAutoScroll = null, e.m_funcErrorMsg = null, e
                    }
                    return i(e, t), e.prototype.isShowing = function() {
                        return this.node.active
                    }, e.prototype.GetPopupID = function() {
                        return this.m_lastPopupID
                    }, e.prototype._onLoad = function() {}, e.prototype._onDestroy = function() {
                        this.Exit()
                        ...
                        return e && console.warn("[\u4f48\u544a\u6b04]\u9019\u9801\u7c64\u9700\u8981\u904e\u6ffe\u904a\u6232, target = " + n), e
                    }, e.prototype.GetThemeIdByGameName = function(t) {
                        return SS.Common.GameEnvironment.GameSetting.hasOwnProperty("Icon") && SS.Common.GameEnvironment.GameSetting.Icon.hasOwnProperty(t) && SS.Common.GameEnvironment.GameSetting.Icon[t].hasOwnProperty("GameName") ? SS.Common.GameEnvironment.GameSetting.Icon[t].GameName : ""
                    }, r([c], e)
                }(cc.Component);
    ...
    BulletinBoardSinglePopupPage: [function(t, e, o) {
        ...
        var l = t("../../../Component/AudioMgr"),
            u = t("./BulletinBoardPage"),
            c = t("./BulletinBoardData"),
            h = u.BulletinBoard.Page,
            p = c.BulletinBoard.ButtonData,
            d = c.BulletinBoard.ButtonType,
            m = cc._decorator,
            _ = m.ccclass,
            y = m.property;
        (function(t) {
            var e = function(t) {
                function e() {
                    var e = null !== t && t.apply(this, arguments) || this;
                    return e.m_btnAction = null, e.m_lblAction = null, e.m_spTexture = null, e.m_buttnData = null, e.m_strTextureName = "", e.m_strPopupID = "", e
                }
                return i(e, t), e.prototype.GetPopupID = function() {
    ...
    BulletinBoardTimerPopupPage: [function(t, e, o) {
        ...
        var a, s = t("./BulletinBoardSinglePopupPage"),
            ...
            u = s.BulletinBoard.SinglePopupPage,
            c = l.BulletinBoard.ButtonData,
                ...
                return i(e, t), e.prototype.onEnable = function() {
                    ...
                    if (null != t)
                        if (this.CheckEndTime(t[0].EndTime)) this.ShowErrorMsg("C55", "Popup(id: " + this.pageID + ") Time Out", !0);
                            ...
                            this.m_btnAction.node.active = !1, this.m_buttnData = new c(t[0]), this.m_lblAction.string = t[0].ButtonText;
                            var e = 0;
